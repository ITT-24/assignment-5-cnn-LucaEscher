...
class GestureRecognitionModel:
    ...
    def prepare_model(self, label_names, size):
        ...
        model = Sequential()
        model.add(Conv2D(64, kernel_size=(9, 9), activation=activation_conv, input_shape=(size, size, self.color_channels), padding='same'))
    ...
    #  Plot garph and confusion matrix if you want to > just change plot to True
